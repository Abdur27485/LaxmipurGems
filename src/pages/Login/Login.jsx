    ...
    return (
        <div>
            <div className='mt-[40px] mb-[80px]'>
                ...
                <form onSubmit={() => console.log("submitted")} className='mx-auto max-w-xs border border-[#590d82] rounded px-5 py-5'>
                    ...
                    <div className="form-control w-full mb-5">
                        ...
                        <input type="password" className="file-input file-input-bordered border-[#FEACC6] w-full max-w-xs px-2" placeholder='Password' />
                    </div>
